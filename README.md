...
Top-level `cinematic` sets composition (`center-hero` or `floating-stage`),
motion, and ambient defaults for non-screenshot content scenes; scene-level
`cinematic` blocks override it.
