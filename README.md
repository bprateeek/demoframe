...
Top-level `cinematic` sets composition (`center-hero`, `floating-stage`, or
`macro-card`), motion, and ambient defaults for non-screenshot content scenes;
scene-level `cinematic` blocks override it.
