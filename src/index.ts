export { demoConfigSchema, budgetToBytes, outputFormats, TEXT_LIMITS, FRAME_VIEWPORTS } from './config/schema.js';
export type { DemoConfig, Scene, Frame, Theme, Output, OutputFormat } from './config/schema.js';
...
export { inspectGif, inspectMp4, inspectWebp } from './qa/report.js';
