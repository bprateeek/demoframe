...
\`demoframe check\`/\`render\` reject a frameless all-screenshot demo; \`--allow-raw-screenshots\` is only for an intentional raw demo such as a bug report or before/after proof.
${END}`;
}
